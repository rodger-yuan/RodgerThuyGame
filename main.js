$( document ).ready(function() {
	...
	var rodger_players_2 = ["Paul George", "Ben Simmons", "Lonzo Ball", "Draymond Green", "Marc Gasol", "Karl-Anthony Towns", "Kevin Love", "Devin Booker", "Eric Bledsoe"]
	var thuy_players_2 = ["John Wall", "Kyrie Irving", "Kyle Lowry", "Jimmy Butler", "DeMar DeRozan", "Joel Embiid", "Victor Oladipo", "Bradley Beal", "Klay Thompson", "Dennis Schroder"]
